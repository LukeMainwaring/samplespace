 ...
 */
export const uploadSample = <ThrowOnError extends boolean = false>(options: Options<UploadSampleData, ThrowOnError>) => (options.client ?? client).post<UploadSampleResponses, UploadSampleErrors, ThrowOnError>({
